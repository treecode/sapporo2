...
/*          copyJParticles.load_source("OpenCL/testkernelDP.cl", "");
          predictKernel.load_source("OpenCL/testkernelDP.cl", "");
          evalgravKernel.load_source("OpenCL/testkernelDP.cl", "");
          reduceForces.load_source("OpenCL/testkernelDP.cl", "");
          evalgravKernel_new.load_source("OpenCL/testkernelDP.cl", "");        
*/	  
        #else
