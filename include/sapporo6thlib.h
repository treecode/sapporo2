/* 6th order integrator as implemented by Sapporo2
*/
...
void set_j_particle(int add, double pos[3], double vel[3], double acc[3],
                    double jrk[3], double snp[3], double crk[3], double mass,
                    double time, int id, double eps2);
...
*/
void pick_up_predictor_2(int addr, int &id, double &mass, double &eps2,
...
void calc_force_on_predictors(int ni, int nj, int ids[], double pos[][3],
                              double vel[][3],double acc[][3], double mass[],
                              double eps2[], double accNew[][3], double jrkNew[][3],
                              double snpNew[][3], double crkNew[][3], double phi[],
                              int nnb[], double nnb_r2[]);
